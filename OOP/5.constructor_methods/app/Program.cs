...
{ 
    ...
    class Product
    {
        ...
        public Product(int productId):this()//this demek git product Constructor ini calistir yani 14. satirdakini calistir demek
        {
            this.ProductId = productId;
        }

        public Product(int productId,string name,double price,bool isApproved):this(productId) //this demek git 2. product Constructor ini calistir yani 20. satirdakini calistir demek
        {
            this.Name = name;
            this.Price=price;
